...
from cacheslide_core.inputs import InputCase as InputCase
from cacheslide_core.inputs import read_cases as read_cases
...
def create_engine(args: argparse.Namespace) -> tuple[Any, Any]:
    ...
    from cacheslide_core.profiles import ProfileBundle
